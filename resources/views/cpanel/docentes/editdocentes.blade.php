                    ...
                    <form action="{{ route('docentes.update', $docente->no_empleado) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="perfil" name="perfil" value="{{ old('perfil', $docente->perfil) }}" placeholder="Ej. Ingeniero en Sistemas">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 mb-3 mb-md-0">
                                ...
                                <input type="text" class="form-control" id="telefono" name="telefono" value="{{ old('telefono', $docente->telefono) }}" placeholder="Ej. 5551234567">
                                @error('telefono') <small class="text-danger">{{ $message }}</small> @enderror
                            </div>
                            <div class="col-md-6">
                                <label for="area" class="form-label fw-semibold">Área Asignada</label>
                                <input type="text" class="form-control" id="area" name="area" value="{{ old('area', $docente->area) }}" placeholder="Ej. Sistemas / Ciencias Básicas">

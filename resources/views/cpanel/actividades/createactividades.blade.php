...
<div class="container-fluid px-0">
    <div class="card shadow-sm border-0 rounded-4">
        <div class="card-header bg-white border-bottom-0 pt-4 pb-0 px-4">
            <h4 class="card-title fw-bold text-dark mb-0"><i class="mdi mdi-map-marker-radius me-2 text-primary"></i> Crear Nuevo Evento</h4>
        </div>
            ...
            <form action="{{ route('actividades.store') }}" method="POST">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control rounded-3" name="nombre" value="{{ old('nombre') }}" placeholder="Ej. Torneo de Ajedrez" required>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control rounded-3" name="horario" value="{{ old('horario') }}" placeholder="Ej. Lunes y Miércoles 14:00 - 16:00" required>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <textarea class="form-control rounded-3" name="descripcion" rows="3" placeholder="Información adicional sobre el evento...">{{ old('descripcion') }}</textarea>
                    </div>
                </div>
                ...
                <div class="mt-4 text-end border-top pt-3">
                    ...
                    <button type="submit" class="btn btn-primary rounded-pill px-4 shadow-sm">
                        <i class="mdi mdi-content-save me-1"></i> Guardar Evento
                    </button>
                </div>
            </form>
        </div>
